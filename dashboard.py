...
def main():
    ...
    if analysis == 'Date':
        column = 'start_date'
        analysis_date_level(data, visits, column)
    elif analysis == 'Hour':
        column = 'visit_hour'
        analysis_hour_level(data, visits, column)
    elif analysis == 'Day of Week':
        column = 'day_of_week'
        analysis_day_week_level(data, visits, column)
    elif analysis == 'Weekend':
        column = 'weekend'
        analysis_weekend_level(data, visits, column)
    elif analysis == 'Month':
        column = 'month'
        analysis_month_level(data, visits, column)
    elif analysis == 'Distance from Home':
        column = 'distance_from_home_miles'
        analysis_distance_from_home_level(data, visits, column)
    elif analysis == 'Distance from Work':
        column = 'distance_from_work_miles'
        analysis_distance_from_work_level(data, visits, column)
